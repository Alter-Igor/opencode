...
describe("plugin.synapse", () => {
  describe("parseJwtPayload & accessTokenIsExpiring", () => {
  ...
  describe("registerKeystoneClient & token exchange mock", () => {
  ...
  describe("SynapseAuthPlugin structure", () => {
